...
import { checkCanonicalV2Integrity } from './canonical-v2-integrity.js';
import { summarizeCanonicalV2Run } from './canonical-v2-summary.js';
import { offerToCanonical } from './offer-to-canonical.js';
import {
  offerToCanonicalV2,
  type CanonicalV2DiscoveryContextInput,
} from './offer-to-canonical-v2.js';
import { saveCanonicalV2Run } from './product-workspace-artifacts.js';
