...
import { saveOzonDraftBundle } from '../../../../packages/core/src/product-draft-artifacts.js';
import {
  buildOzonProductDraft,
  normalizeDraftNetWeight,
} from '../../../../packages/steps/draft-generation/src/legacy-draft-builder.js';
import {
  OZON_DRAFT_ATTRIBUTE_IDS,
  OZON_DRAFT_ATTRIBUTE_RULES,
} from '../../../../packages/steps/draft-generation/src/attribute-rules.js';
...
describe('Ozon draft Skill', () => {
  it('is routed from the repository and keeps one fixed output schema', () => {
    const skillPath = 'packages/steps/draft-generation/SKILL.md';
    ...
    const schema = JSON.parse(fs.readFileSync(path.join(
      repoRoot,
      'packages/steps/draft-generation/output.schema.json',
